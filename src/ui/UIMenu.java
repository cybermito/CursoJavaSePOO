...
public class UIMenu {
    ...
    private static void authUser(int userType){
        //En esta clase vamos a comprobar que tipo de usuario es y hacer que se loguee para mostrarle el menún correspondiente.
        //userType = 1 Doctor
        //userType = 2 Patient
        ...
        patients.add(new Patient("Antonio Mesa", "Antonio@mail.com"));
        patients.add(new Patient("Nuria Mariella", "Nuria@mail.com"));
        patients.add(new Patient("Luna Mesa", "Luna@mail.com"));
